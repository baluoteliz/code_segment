...
namespace plusFCL_BTL
{
	...
	CFileXml::CFileXml(const std::string &xmlPath)
	{
		xmlFile_ = xmlPath;
		CFileIO::generatorFile(xmlPath);
	}
	...
	CFileJson::CFileJson(const std::string &jsonPath)
	{
		jsonFile_ = jsonPath;
		CFileIO::generatorFile(jsonPath);
	}
